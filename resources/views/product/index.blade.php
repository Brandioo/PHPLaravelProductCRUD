        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <h4 class="mb-3">All Products
                    <a class="btn btn-sm btn-outline-success float-end" href="create"><i class="fa fa-plus"></i> Add
                        Product</a>
                </h4>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <a href="{{ url('read/'.$product->id) }}"
                                           class="btn btn-sm btn-outline-primary text-decoration-none m-1"><i
                                                class="fa fa-eye"></i> </a>
                                        <a href="{{ url('update/'.$product->id.'/edit') }}"
                                           class="btn btn-sm btn-outline-success text-decoration-none m-1"><i
